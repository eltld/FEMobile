package com.feunju.bean.json;

public final class AutoridadTag {


	public static final String AUTORIDAD_ID="autoridad_id";
	public static final String AUTORIDAD_TITULO="autoridad_titulo";
