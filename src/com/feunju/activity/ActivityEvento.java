...
import com.feunju.bean.adapter.CustomEventoAdapter;
import com.feunju.bean.adapter.CustomNewsAdapter;
import com.feunju.bean.json.EventoTag;
    		...
    		if(jsonString!=null && jsonString.length()!=0)
		    {
    			try
    			{
    				...
    				for(int i=0; i<jsonArray.length();i++)
    				{
    				   ...
    				   evento.setBajadaEvento(jsonObject.getString(EventoTag.EVENTO_BAJADA));
